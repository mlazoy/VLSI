...
HD_PWD='/home/mlazoy/lab_5/lab_5.runs/design_1_fir_IP_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_fir_IP_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_fir_IP_0_0.tcl
